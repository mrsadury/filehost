...
<head>
    ...
    <title>Host Had - Free Web Hosting</title>
    <!-- Bootstrap 5 CSS -->
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-white shadow-sm">
        <div class="container">
            <a class="navbar-brand animate__animated animate__fadeIn" href="index.php">
                <i class="fas fa-cloud-upload-alt me-2"></i>HOST HAD
            </a>
    ...
    <footer class="animate__animated animate__fadeIn animate__delay-1s">
        <div class="container text-center">
            <h4><i class="fas fa-cloud me-2"></i>HOST HAD</h4>
            <p class="mb-3">Free file hosting with editing capabilities</p>
            <div class="social-icons mb-3">
                <a href="https://hosthad.com" class="text-white me-3"><i class="fas fa-globe"></i></a>
                <a href="https://t.me/GENXONE" class="text-white me-3"><i class="fab fa-telegram-plane"></i></a>
            </div>
            <p class="small">&copy; <?= date('Y') ?> HOST HAD. All rights reserved.</p>
        </div>
    </footer>
